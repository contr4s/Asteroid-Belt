...
static public class SaveGameManager
{
    ...
    static public void Save()
    {
        ...
        saveFile.firedBullets = AchievementManager.S.amountOfFiredBullets;
        saveFile.luckyShots = AchievementManager.S.amountOfLuckyShots;
        saveFile.achievements = AchievementManager.S.Achievements;
    ...
    static public void Load()
    {
        if (File.Exists(filePath))
        {
            ...
            AchievementManager.S.LoadDataFromSaveFile(saveFile);
        ...
        else
        {
            ...
            // Init Achievements
            AchievementManager.S.ClearStepsAndAchievements();
...
public class SaveFile
{
    ...
    public List <AchievementManager.Achievement> achievements;
